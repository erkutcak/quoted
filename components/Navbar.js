            ...
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium bg-ash-black rounded-full">
                <Link href="/home" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group rounded-l-full">
                    <button type="button" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group rounded-l-full">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-steel-blue dark:group-hover:text-steel-blue">Home</span>
                    </button>
                </Link>
                <Link href="/myquotes" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <button type="button" className="inline-flex flex-col items-center justify-center px-1 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <svg className="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-steel-blue dark:group-hover:text-steel-blue" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path>
                    </svg>
                        <span className="w-20 text-xs text-gray-500 dark:text-gray-400 group-hover:text-steel-blue dark:group-hover:text-steel-blue">My Quotes</span>
                    </button>
                </Link>
                <Link href="/newquote" className="inline-flex flex-col items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <button type="button" className="inline-flex flex-col items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        ...
                        <span className="w-20 text-xs text-gray-500 dark:text-gray-400 group-hover:text-steel-blue dark:group-hover:text-steel-blue">New Quote</span>
                    </button>
                </Link>
